...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'property.create': {
    roles: ['administrative-staff', 'real-estate-agent', 'property-inspector'],
    key: 'property-listed',
    tenantPath: ['organization', 'user', 'property'],
    userPath: [],
  },
  'property.update': {
    roles: ['administrative-staff', 'real-estate-agent', 'property-inspector'],
  ...
  'offer.create': {
    roles: ['administrative-staff', 'property-seller', 'real-estate-agent'],
    key: 'offer-made',
    tenantPath: ['organization', 'user', 'property', 'offer'],
    userPath: [],
  },
  'inspection.create': {
    roles: ['administrative-staff', 'property-seller', 'real-estate-agent', 'property-buyer'],
    key: 'inspection-added',
    tenantPath: ['organization', 'user', 'property', 'inspection'],
    userPath: [],
  },
  'interest.create': {
    roles: ['administrative-staff', 'property-seller', 'real-estate-agent'],
    key: 'interest-expressed',
    tenantPath: ['organization', 'user', 'property', 'interest'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['administrative-staff'];
