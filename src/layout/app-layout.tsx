...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Interests', path: '/interests', entity: 'interest', service: AccessServiceEnum.PROJECT, icon: FiHeart },
    { name: 'Offers', path: '/offers', entity: 'offer', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
